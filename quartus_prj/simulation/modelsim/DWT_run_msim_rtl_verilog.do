...
vlog -vlog01compat -work work +incdir+C:/Users/user/FPGA\ project/My\ code/DWT/rtl {C:/Users/user/FPGA project/My code/DWT/rtl/DWT_1D1L.v}

vlog -vlog01compat -work work +incdir+C:/Users/user/FPGA\ project/My\ code/DWT/quartus_prj/../sim {C:/Users/user/FPGA project/My code/DWT/quartus_prj/../sim/tb_DWT_1D1L.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  tb_DWT_1D1L
